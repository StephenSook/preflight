...
async function main(): Promise<void> {
  ...
  const app = buildServer({ config, store, decisions, ledger, graphStore, holds, consents, resolver, declaration, applicationPublicKeyPem: publicKeyPem, applicationPrivateKeyPem: privateKeyPem });
